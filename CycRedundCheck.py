'''
	Program CycRedundCheck.py
	
Description: ------------------------------------------------------------------
	This file contains the class construct to computes the Cyclic Redundancy 
Check (CRC) of the data stream sent/returned to the devices or equipment 
connected via USB ports to the controlling conputer. 

History: ----------------------------------------------------------------------
  V1.0 - Oct-2017  First public release.
  V1.4 - Jul-2018  Updated comments.
  V1.5 - Sep-2018  Removed generating lookup table code and inserted complete table.
Environment: ------------------------------------------------------------------
...
if __name__ == '__main__':
    ...
    print ("test case: 0106002C008D")
    crc = 0xFFFF
    st = "\x01\x06\x00\x2C\x00\x8D"
    for ch in st:
        crc = ck.calcByte( ch, crc)
